...
**ALX Software Engineering program** project on object-relational mapping. The aim here is to learn about how to connect to a MySQL database from a Python script, what ORM means and how to map a Python Class to a MySQL table.
